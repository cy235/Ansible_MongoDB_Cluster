...
![image](https://github.com/cy235/MongoDB_Cluster/blob/master/MongoDB2.png)
 where a complete dataset consists of 3 replica sets, no arbiter set is allowed in configuration cluster, while both arbiter and secondary sets are allowed in
replica sets.
## 3. Prerequisite
